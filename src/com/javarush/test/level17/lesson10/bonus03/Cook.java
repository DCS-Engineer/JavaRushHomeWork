...
public class Cook implements Runnable {
    ...
    private void cooking() throws InterruptedException {
        ...
        manager.getDishesQueue().add(new Dishes(order.getTableNumber()));       //  это готовое блюдо
        System.out.println(String.format("Заказ для стола №%d готов", order.getTableNumber()));
    }
}
